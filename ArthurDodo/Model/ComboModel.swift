...
struct ComboModel: FoodItems {
    ...
    init(id: UUID = UUID(), category: CategoriesNames = .combos, name: String, imageName: String, ingredients: String, isHit: Bool = false, items: [Pizza?]?, size: [Size: WeightPrice], isHeader: Bool = false) {
        self.id = id
