...
struct Pizza {
    ...
    let size: [Size: WeightPrice]
    let isHit: Bool

    init(name: String, ingredients: String, imageName: String, size: [Size: WeightPrice], isHit: Bool = false) {
        self.name = name
...
let Pizzas: [Pizza] = [
    ...
    Pizza(name: "Аррива!",
          ingredients: "Цыпленок, острые колбаски чоризо, соус бургер, сладкий перец, красный лук, томаты, моцарелла, соус ранч, чеснок",
          imageName: "pizza",
          size: [.small: WeightPrice(weight: 300, price: 500, cpfc: CPFC(calories: "110", protein: "12", fat: "14", carbohydrates: "30")),
                 .medium: WeightPrice(weight: 400, price: 600, cpfc: CPFC(calories: "200", protein: "14", fat: "16", carbohydrates: "44")),
                 .large: WeightPrice(weight: 500, price: 700, cpfc: CPFC(calories: "300", protein: "17", fat: "22", carbohydrates: "55"))]
    ...
    Pizza(name: "Сырный цыпленок",
          ingredients: "Цыпленок, сыры чеддер, моцарелла, фирменный томатный соус",
          imageName: "pizza",
          size: [.small: WeightPrice(weight: 300, price: 500, cpfc: CPFC(calories: "110", protein: "12", fat: "14", carbohydrates: "30")),
                 .medium: WeightPrice(weight: 400, price: 600, cpfc: CPFC(calories: "200", protein: "14", fat: "16", carbohydrates: "44")),
                 .large: WeightPrice(weight: 500, price: 700, cpfc: CPFC(calories: "300", protein: "17", fat: "22", carbohydrates: "55"))]
