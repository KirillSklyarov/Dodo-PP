...
struct Pizza: FoodItems {
    ...
    init(id: UUID = UUID(), category: CategoriesNames = .pizzas, name: String, ingredients: String, imageName: String, size: [Size: WeightPrice], isHit: Bool = false, weight: Int? = nil, price: Int? = nil, isHeader: Bool = false) {
        self.id = id
        self.name = name
...
let pizzas: [Pizza] = [
    ...
    Pizza(name: "Креветки со сладким чили", ingredients: "Креветки , ананасы , соус сладкий чили, сладкий перец , моцарелла, фирменный соус альфредо",
          imageName: "chilli",
          size: [.small: WeightPrice(weight: 300, price: 500, cpfc: CPFC(calories: 110, protein: 12, fat: 14, carbohydrates: 30)),
                 .medium: WeightPrice(weight: 400, price: 600, cpfc: CPFC(calories: 200, protein: 14, fat: 16, carbohydrates: 44)),
                 .large: WeightPrice(weight: 500, price: 700, cpfc: CPFC(calories: 300, protein: 17, fat: 22, carbohydrates: 55))])
