...
//final class ProfileContentCollectionView: UICollectionView {
//
//    // MARK: - Properties
...
// MARK: - Config Layout
//extension ProfileContentCollectionView {
...
//            switch section {
//            case 0: return self.setupDodoCoinsOrdersSection()
...
//    }
//
//    private func setupDodoCoinsOrdersSection() -> NSCollectionLayoutSection {
...
//extension ProfileContentCollectionView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
//            let data = testCoinsOrdersModel[indexPath.item]
